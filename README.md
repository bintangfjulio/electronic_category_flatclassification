...
## Run It
python main.py --model=... --method=... --loss=...</br></br>There are model & method options for run main.py:</br>1. model: bert, bert-cnn, bert-bilstm, bert-lstm</br>2. method: flat, level, section</br>3. loss: binary, categorical